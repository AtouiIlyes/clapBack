...
ActiveRecord::Schema.define(version: 2019_03_08_132223) do
  ...
  create_table "proceedings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "code"
    t.string "libelle"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "proceedings_steps", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
